...
#xTrain <- read.fwf(paste(dataSetPath, '/train/X_train.txt', sep=''), rep(16, 561), header=FALSE, n=10, blank.lines.skip = TRUE)
#xTest  <- read.fwf(paste(dataSetPath, '/test/X_test.txt', sep=''), rep(16, 561), header=FALSE, n=10, blank.lines.skip = TRUE)
